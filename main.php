		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
						...
						<div class="inner">
							...
							<!-- Content -->
								<section>
									...
									<h1>Почему?</h1>
									<h1><p>Вы неосуществили оплату за курс.<br></h1>
                    <h1></h1>
                    <h1></h1>
                  ...
                  <h1></h1>
                  <h1></h1>
									<h1>После оплаты вам откроется доступ ко всем имеющимся материалам курса.Прежде всего,мы нацелены на результаты и успехи наших клиентов.</h1>
