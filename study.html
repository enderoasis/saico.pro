...
<html lang="en" dir="ltr">
  ...
  <body class="is-preload">
    <section>
      ...
      <div class="posts">
        <article>
          ...
          <ul class="actions">
            <li><a href="/lessons/1" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/2" class="image"><img src="images/pic02.jpg" alt="" /></a>
    ...
    Это базовая ошибка, но, к сожалению, время от времени, мы все еще наталкиваемся на такие вот закрытые аккаунты брендов. Если закрытые аккаунты для личных профилей — это нормально, то для компаний это, как минимум, странно.
          ...
          <ul class="actions">
            <li><a href="/lessons/2" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/3" class="image"><img src="images/pic03.jpg" alt="" /></a>
          ...
          <ul class="actions">
            <li><a href="/lessons/3" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/4" class="image"><img src="images/pic04.jpg" alt="" /></a>
          ...
          <ul class="actions">
            <li><a href="/lessons/4" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/5" class="image"><img src="images/pic05.jpg" alt="" /></a>
          ...
          <ul class="actions">
            <li><a href="/lessons/5" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/6" class="image"><img src="images/pic06.jpg" alt="" /></a>
          ...
          <ul class="actions">
            <li><a href="/lessons/6" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/7" class="image"><img src="images/pic06.jpg" alt="" /></a>
          ...
          <ul class="actions">
            <li><a href="/lessons/7" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/8" class="image"><img src="images/pic06.jpg" alt="" /></a>
          ...
          <ul class="actions">
            <li><a href="/lessons/8" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/9" class="image"><img src="images/pic06.jpg" alt="" /></a>
          ...
          <ul class="actions">
            <li><a href="/lessons/9" class="button">Перейти</a></li>
          </ul>
        </article>
        <article>
          <a href="/lessons/10" class="image"><img src="images/pic06.jpg" alt="" /></a>
