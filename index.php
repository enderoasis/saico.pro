...
«Saico education»  гарантирует конфиденциальность вашей информации. Мы создали специальный портал. Здесь предоставлены всевозможные материалы для обучения,а так же выдача задании для закрепления пройденных уроков на каждый день. Также на этот портал вы будете отправлять свои отчеты. Марафон будет проводиться только здесь. </p>
									...
									<div class="features">
										...
										<article>
											...
											<div class="content">
												...
												<p>Программа SMM от Saico.pro охватывает популярные социальные сети, способствующие продвижению вашего бизнеса, построению имиджа бренда и продажам.Кроме того, по окончании курса вы сможете создать стратегию, охватывающую все сети.</p>
											</div>
										</article>
									</div>
								</section>
							...
							<!-- Section -->
								<section>
									...
									<div class="posts">
										<article>
											<a href="first.html" class="image"><img src="image/p2.png" alt="" /></a>
											...
											<ul class="actions">
												<li><a href="first.html" class="button">Начать</a></li>
											</ul>
										</article>
                    <article>
          <a href="/lessons/11.php" class="image"><img src="image/p3.png" alt="" /></a>
                      <h3>1. 7 Ошибок при продвижении</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                    ...
                    <article>
          <a href="/lessons/12.php" class="image"><img src="image/p4.png" alt="" /></a>
                      <h3>2. 8 Советов по SMM продвижению</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                        <li><a href="/lessons/12.php" class="button">Начать</a></li>
                      </ul>
                    </article>
                    <article>
          <a href="/lessons/13.php" class="image"><img src="image/p5.png" alt="" /></a>
                      <h3>3. SMM для ленивых</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                        <li><a href="/lessons/13.php" class="button">Начать</a></li>
                      </ul>
                    </article>
                    <article>
          <a href="/lessons/14.php" class="image"><img src="image/content.png" alt="" /></a>
                      <h3>4. Идеальные размеры фото и видео</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                    ...
                    <article>
          <a href="/lessons/15.php" class="image"><img src="image/ser.png" alt="" /></a>
                      <h3>5. Как использовать социальные сети</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                    ...
                    <article>
          <a href="/lessons/16.php" class="image"><img src="image/p6.png" alt="" /></a>
                      <h3>6. Всё об опросах в Instagram</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                    ...
                    <article>
          <a href="/lessons/17.php" class="image"><img src="image/p7.png" alt="" /></a>
                      <h3>7. Как сократить расходы на рекламу</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                    ...
                    <article>
          <a href="/lessons/18.php" class="image"><img src="image/p8.png" alt="" /></a>
                      <h3>8. 7 Ошибок при продвижении</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                        <li><a href="/lessons/18.php" class="button">Начать</a></li>
                      </ul>
                    </article>
                    <article>
          <a href="/lessons/19.php" class="image"><img src="image/p9.png" alt="" /></a>
                      <h3>9. Учимся сохранять фото или видео в Instagram </h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
                        <li><a href="/lessons/19.php" class="button">Начать</a></li>
                      </ul>
                    </article>
                    <article>
          <a href="/lessons/20.php" class="image"><img src="image/p10.png" alt="" /></a>
                      <h3>10. Лучшие сервисы для продвижения</h3>
                      <p>Хотите сократить расходы на рекламу в Instagram, не пожертвовав при этом её эффективностью? Для этого достаточно правильно настроить таргетинг объявлений. Для этого социальная сеть предоставляет удобные инструменты. Вам просто нужно изучить их и научиться правильно использовать в ваших рекламных компаниях.</p>
                      <ul class="actions">
						...
						<div class="inner">
							...
							<!-- Section -->
								<section>
									...
									<p>Ниже приведены контакты в целях оказания тех.поддержки, более эффективного сотрудничества и.т.д</p>
									<ul class="contact">
