									...
									<div class="features">
										...
										<article>
											...
											<div class="content">
												...
												<p>Программа SMM от Saico.pro охватывает популярные социальные сети, способствующие продвижению вашего бизнеса, построению имиджа бренда и продажам. Кроме того, по окончанию курса вы сможете создать стратегию, охватывающую все сети.</p>
											</div>
										</article>
									</div>
								</section>
...
Это базовая ошибка, но, к сожалению, время от времени, мы все еще наталкиваемся на такие вот закрытые аккаунты брендов. Если закрытые аккаунты для личных профилей — это нормально, то для компаний это, как минимум, странно.
										...
										<article>
											<a href="#1" class="image"><img src="image/pic08.jpg" alt="" /></a>
						...
						<div class="inner">
							...
							<!-- Menu -->
								<nav id="menu">
									...
									<ul>
										<li><a href="check.php">Учебный портал</a></li>
